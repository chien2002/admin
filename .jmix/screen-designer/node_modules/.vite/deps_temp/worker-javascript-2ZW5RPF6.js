...
var require_worker_javascript = __commonJS({
  "node_modules/ace-builds/src-noconflict/worker-javascript.js"(exports) {
    "no use strict";
    !function(window2) {
        ...
        Lexer.prototype = {
          ...
          token: function() {
            ...
            var create = function(type, value, isProperty, token2) {
              ...
              obj.from = this.from;
              if (obj.identifier && token2)
                obj.raw_text = token2.text || token2.value;
...
//# sourceMappingURL=worker-javascript-2ZW5RPF6.js.map
