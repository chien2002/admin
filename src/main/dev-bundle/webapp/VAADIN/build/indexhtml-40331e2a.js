 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var Et;const On=window;((Et=On.HTMLSlotElement)===null||Et===void 0?void 0:Et.prototype.assignedElements)!=null;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */class Vn extends Dn{constructor(e){var t;if(super(e),e.type!==zn.ATTRIBUTE||e.name!=="class"||((t=e.strings)===null||t===void 0?void 0:t.length)>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var i,n;if(this._previousClasses===void 0){this._previousClasses=new Set,e.strings!==void 0&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in t)t[s]&&!(!((i=this._staticClasses)===null||i===void 0)&&i.has(s))&&this._previousClasses.add(s);return this.render(t)}const r=e.element.classList;this._previousClasses.forEach(s=>{s in t||(r.remove(s),this._previousClasses.delete(s))});for(const s in t){const l=!!t[s];l!==this._previousClasses.has(s)&&!(!((n=this._staticClasses)===null||n===void 0)&&n.has(s))&&(l?(r.add(s),this._previousClasses.add(s)):(r.remove(s),this._previousClasses.delete(s)))}return te}}const Xo=Mn(Vn),Ct="css-loading-indicator";var z;(function(o){o.IDLE="",o.FIRST="first",o.SECOND="second",o.THIRD="third"})(z||(z={}));class C extends ie{constructor(){super(),this.firstDelay=450,this.secondDelay=1500,this.thirdDelay=5e3,this.expandedDuration=2e3,this.onlineText="Online",this.offlineText="Connection lost",this.reconnectingText="Connection lost, trying to reconnect...",this.offline=!1,this.reconnecting=!1,this.expanded=!1,this.loading=!1,this.loadingBarState=z.IDLE,this.applyDefaultThemeState=!0,this.firstTimeout=0,this.secondTimeout=0,this.thirdTimeout=0,this.expandedTimeout=0,this.lastMessageState=E.CONNECTED,this.connectionStateListener=()=>{this.expanded=this.updateConnectionState(),this.expandedTimeout=this.timeoutFor(this.expandedTimeout,this.expanded,()=>{this.expanded=!1},this.expandedDuration)}}static create(){var e,t;const i=window;return!((e=i.Vaadin)===null||e===void 0)&&e.connectionIndicator||(i.Vaadin=i.Vaadin||{},i.Vaadin.connectionIndicator=document.createElement("vaadin-connection-indicator"),document.body.appendChild(i.Vaadin.connectionIndicator)),(t=i.Vaadin)===null||t===void 0?void 0:t.connectionIndicator}render(){return R`
...
`,x=class extends ie{constructor(){super(),this.expanded=!1,this.messages=[],this.notifications=[],this.frontendStatus="unavailable",this.javaStatus="unavailable",this.tabs=[{id:"log",title:"Log",render:this.renderLog,activate:this.activateLog},{id:"info",title:"Info",render:this.renderInfo},{id:"features",title:"Feature Flags",render:this.renderFeatures}],this.activeTab="log",this.serverInfo={flowVersion:"",vaadinVersion:"",javaVersion:"",osVersion:"",productName:""},this.features=[],this.unreadErrors=!1,this.componentPickActive=!1,this.nextMessageId=1,this.transitionDuration=0,window.Vaadin.Flow&&this.tabs.push({id:"code",title:"Code",render:this.renderCode})}static get styles(){return[b`
    ...
    `}render(){return R` <div
      ...
      <div>
        ...
        <button
          class="button pick"
          @click=${()=>{this.componentPickActive=!0,Be(()=>import("./component-picker-b5df60de.js"),[],import.meta.url)}}
        >
...
`;Qe("",Bt,{moduleId:"lumo-typography"});const ni=document.createElement("template");ni.innerHTML=`<style>${lr.toString().replace(":host","html")}</style>`;document.head.appendChild(ni.content);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const cr=b`
...
`,ri=document.createElement("template");ri.innerHTML=`<style>${cr.toString().replace(":host","html")}</style>`;document.head.appendChild(ri.content);const Ht=b`
  [theme~='dark'] {
    /* Base (background) */
...
`;const li=document.createElement("template");li.innerHTML=`<style>${dr.toString().replace(":host","html")}$</style>`;document.head.appendChild(li.content);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ci=b`
...
${yr}
${br}
`;Qe("",di,{moduleId:"lumo-utility"});const ye=(o,e)=>{const t=document.createElement("style");t.type="text/css",t.appendChild(document.createTextNode(o)),e===document?document.head.appendChild(t):e.appendChild(t)};window.Vaadin=window.Vaadin||{};window.Vaadin.theme=window.Vaadin.theme||{};window.Vaadin.theme.injectedGlobalCss=[];const xr=o=>{document["_vaadintheme_jmix-lumo_componentCss"]||(document["_vaadintheme_jmix-lumo_componentCss"]=!0),ye(Bt.cssText,o),ye(Ht.cssText,o),ye(si.cssText,o),ye(ci.cssText,o),ye(di.cssText,o)},Ro=(o,e)=>{const t=document.createElement("style");t.type="text/css",t.appendChild(document.createTextNode(o)),e===document?document.head.appendChild(t):e.appendChild(t)};window.Vaadin=window.Vaadin||{};window.Vaadin.theme=window.Vaadin.theme||{};window.Vaadin.theme.injectedGlobalCss=[];const wr=o=>{xr(o),document._vaadintheme_untitled_componentCss||(document._vaadintheme_untitled_componentCss=!0),Ro(Ht.cssText,o),Ro(Bt.cssText,o)},_r=wr;_r(document);export{Dn as D,ie as L,zn as P,Tr as T,Be as _,Ht as a,tr as b,b as c,Ue as d,te as e,Mn as f,ti as g,R as h,_ as i,fe as j,S as n,Zn as p,Pn as q,Qe as r,Er as s,Bt as t,nn as u};
